...
pub fn run() {
    ...
    let file_content = include_bytes!("../../../tendermint-fixtures/1/signed_header.json");
    ...
    let file_content = include_bytes!("../../../tendermint-fixtures/1/validators.json");
    let file_content_str =
        core::str::from_utf8(file_content).expect("Failed to convert file content to string");
    ...
    let file_content = include_bytes!("../../../tendermint-fixtures/1/next_validators.json");
    let file_content_str =
        core::str::from_utf8(file_content).expect("Failed to convert file content to string");
    ...
    // // Generate the Light Block's without testgen
    let file_content = include_bytes!("../../../tendermint-fixtures/2/signed_header.json");
    let file_content_str =
        core::str::from_utf8(file_content).expect("Failed to convert file content to string");
    ...
    let file_content = include_bytes!("../../../tendermint-fixtures/2/validators.json");
    let file_content_str =
        core::str::from_utf8(file_content).expect("Failed to convert file content to string");
    let validators_response: ValidatorSetResponse =
        serde_json::from_str(file_content_str).expect("Failed to parse JSON");
    ...
    let file_content = include_bytes!("../../../tendermint-fixtures/2/next_validators.json");
    let file_content_str =
        core::str::from_utf8(file_content).expect("Failed to convert file content to string");
    let next_validators_response: ValidatorSetResponse =
        serde_json::from_str(file_content_str).expect("Failed to parse JSON");
